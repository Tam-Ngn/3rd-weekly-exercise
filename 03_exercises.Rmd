...
Interpretation: There is no data for the months of Jan through September. Within the observed time frame, ridership increases in October, stays relatively higher throughout the month and starts to decline dramatically as winter comes.
...
Trips %>% 
  ...
  labs(title = "Ridership according to time of day",
       ...
       x = "")
```
  Interpretation: On a day, ridership is highest in daytime between 7am and 5pm.
